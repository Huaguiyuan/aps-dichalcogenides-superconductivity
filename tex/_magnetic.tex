...
\begin{equation}
\ln\frac{T_{c}^{0}}{T}=\frac{1}{2}\left[\psi(\frac{1}{2}+\frac{iμ_{B}B_{c}}{2π T})+\psi(\frac{1}{2}-\frac{iμ_{B}B_{c}}{2π T})\right]-\psi(\frac{1}{2}),\label{eq: conventional_pair_breaking_eq}
\end{equation}
