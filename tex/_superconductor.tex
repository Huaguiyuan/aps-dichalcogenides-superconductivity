\section{Superconducting States}
...
This has identical form to the standard BCS Hamiltonian with
...
For local attractive density-density interaction
...
The resulting Hamiltonian has the same form as the BCS Hamiltonian
\cref{eq:sc:induced:projected}
...
This result also suggests that intravalley pairing requires
odd parity couplings that may arise from spin exchange interactions.
