...
% TODO The use of sigma is problematic
%      as we used the sigma operator for orbital basis.
%      Maybe we can change \sigma to s everywhere.
...
% TODO Need to define what are v^c and v^v.
%      Maybe a better definition would be
%      v^1 and v^2 where 1 and 2 are the orbitals.
\begin{equation}
  \begin{aligned}
    \Ket{u_{τ σ}^n \of{k, ϕ}}
